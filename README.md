...
## Features
- lik-mac-compat supports all 32-bit iOS devices, and some 64-bit (A7/A8/A9/A10/A11) devices
    ...
    - lik-mac-compat defines *legacy devices* as all iOS devices that are vulnerable to a bootrom exploit (checkm8 and older)
